...
export default function Sidebar({
  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '1.25rem 1.25rem 0.75rem 1.25rem', borderBottom: '1px solid #1e293b' }}>
        <div style={{ fontSize: '0.68rem', fontWeight: 700, textTransform: 'uppercase', color: '#64748b', letterSpacing: '0.06em', marginBottom: '0.5rem' }}>
          SYSTEM PIPELINE
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.4rem', fontSize: '0.75rem' }}>
          ...
          {climateLoaded ? (
            ...
            <span style={{ color: '#f59e0b', display: 'flex', alignItems: 'center', gap: '0.2rem', fontWeight: 600 }}>
              ...
              >
                ...
                {item.badge && (
                  <span style={{
                    ...
                    borderRadius: '4px',
                    fontWeight: 700,
                    backgroundColor: item.badge === 'Loaded' || item.badge === 'Done' ? '#064e3b' : '#78350f',
                    color: item.badge === 'Loaded' || item.badge === 'Done' ? '#6ee7b7' : '#fde68a'
                  }}>
                    {item.badge}
                  </span>
                )}
      ...
      <div style={{
        ...
        <div style={{ fontWeight: 600, color: '#94a3b8' }}>Thermal Sense v1.0</div>
